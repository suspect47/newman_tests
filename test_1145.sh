...
WORKDIR=/home/user/tests/workdir/testdir_1145
...
WAITS1=10 # change the WAITS1 here
...
cd $WORKDIR && newman run PeoplePass.postman_collection.json --timeout-request 30000 --delay-request 1600 -e PeoplePass.postman_environment.json -d monpass-4.csv >> $WORKDIR/logs/test_1145.txt
