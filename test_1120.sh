...
WORKDIR=/home/user/tests/workdir/testdir_1120
...
cd $WORKDIR && newman run PeoplePass.postman_collection.json --timeout-request 30000 --delay-request 1600 -e PeoplePass.postman_environment.json -d monpass-3.csv >> $WORKDIR/logs/test_1120.txt
