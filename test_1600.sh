...
WORKDIR=/home/user/tests/workdir/testdir_1600
...
WAITS1=8 # change the WAITS1 here
...
cd $WORKDIR && newman run PeoplePass.postman_collection.json --timeout-request 30000 --delay-request 600 -e PeoplePass.postman_environment.json -d evnpass-1.csv >> $WORKDIR/logs/test_1600.txt
