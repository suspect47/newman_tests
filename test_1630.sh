...
WORKDIR=/home/user/tests/workdir/testdir_1630
...
cd $WORKDIR && newman run PeoplePass.postman_collection.json --timeout-request 30000 --delay-request 600 -e PeoplePass.postman_environment.json -d evnpass-2.csv >> $WORKDIR/logs/test_1630.txt
